...
public class Persistence {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.code.Entities");
    ...
    final Properties additionalProperties() {
        ...
        hibernateProperties.setProperty("hibernate.hibernate.show_sql", env.getProperty("hibernate.show_sql"));

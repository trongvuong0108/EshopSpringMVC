        ...
        <div class="col-lg-4 col-6 text-right">
            <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="dangky.html" class="dropdown-item">Đăng Ký</a>
                    <a href="dangnhap.html" class="dropdown-item">Đăng Nhập</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row px-xl-5">
            ...
            <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item position-relative active" style="height: 430px;">
                        <img class="position-absolute w-100 h-100"  src="<c:url value="/resources/img/banner1.jpg"/>" style="object-fit: cover;">
                    ...
                    <div class="carousel-item position-relative" style="height: 430px;">
                        <img class="position-absolute w-100 h-100" src="<c:url value="/resources/img/keyboard1.jpg"/>" style="object-fit: cover;">
                    ...
                    <div class="carousel-item position-relative" style="height: 430px;">
                        <img class="position-absolute w-100 h-100" src="<c:url value="/resources/img/mouse2.jpg"/>" style="object-fit: cover;">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
        ...
        <div class="col-lg-4">
            <div class="product-offer mb-30" style="height: 200px;">
                <img class="img-fluid" src="<c:url value="/resources/img/banner2.jpg"/>" alt="">
            ...
            <div class="product-offer mb-30" style="height: 200px;">
                <img class="img-fluid" src="<c:url value="/resources/img/banner3.jpg"/>" alt="">
                <div class="offer-text">
                    <h6 class="text-white text-uppercase">Save 20%</h6>
                    <h3 class="text-white mb-3">Special Offer</h3>
                    <a href="" class="btn btn-primary">Shop Now</a>
